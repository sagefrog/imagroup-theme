...
if( $status == 'show' ){
	...
	$overlay_color = get_sub_field( 'full_width_image_content_background_overlay_color' );
    $desktop_image = get_sub_field( 'full_width_image_content_desktop_image' );
    $mobile_image = get_sub_field( 'full_width_image_content_mobile_image' );
    $sub_heading = get_sub_field( 'full_width_image_content_sub_heading' );
    $heading_content = get_sub_field( 'full_width_image_content_heading_content' );
    $button = get_sub_field( 'full_width_image_content_button' );
    ...
    <section <?php imagroup_section_id($id); ?> class="content-part <?php echo esc_attr($overlay_color); ?> mobile-banner-none pt-xl-150 pb-xl-150 pt-md-125 pb-md-125 pb-100 banner-bg <?php echo esc_attr($extra_class); ?>" data-background="<?php if( !empty($desktop_image) ){ echo esc_url($desktop_image['url']); } ?>">
        ...
        <div class="container">
            <div class="content-row">
                <div class="row">
                    <div class="offset-lg-7 col-lg-5 offset-md-5 col-md-7 col-sm-12 col-12">
                        <div class="content-title max-width-424 ml-auto <?php if( $overlay_color == 'bg-blue' ){ echo 'white-color'; } ?> body-xl wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="0.5s"><?php
                            ...
                            $button_attr = imagroup_acf_link( $button, 'btn btn2 btn-primary text-white' );
